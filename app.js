...
var srv = apiai("xxxxxxxxxx"); //api.ai key
...
function receivedMessage(event) {
    ...
    var msgAPIText;    
    if (quickReply) {
        msgAPIText = quickReply.payload;
        console.log("Quick reply for message %s with payload %s", messageId, quickReply.payload);
    } else {
        msgAPIText = message.text;
    }

    var requestAPI = srv.textRequest(msgAPIText, {
    ...
    requestAPI.on('response', function (response) {
        ...
        /*
         * use the response from api.ai to format the reply being sent to the user
         * check the various response formats available :- https://developers.facebook.com/docs/messenger-platform/send-api-reference
         */
 ...
 *
 */
function sendQuickReply(recipientId, userOptionsList, userOptionsText) {
    var messageData = {
        recipient: {
            id: recipientId
        },
        message: {
            text: userOptionsText,
            quick_replies: userOptionsList
        }
    };
